...
from .principles import PrincipleInjection, build_principle_system_prompt
...
def make_ethics_task(
    ...
    if isinstance(injection, PrincipleInjection):
        sys_prompt = build_principle_system_prompt(injection, BASE_INSTRUCTION)
...
def make_utilitarianism_shuffled_task(
    ...
    elif isinstance(injection, PrincipleInjection):
        sys_prompt = build_principle_system_prompt(injection, BASE_INSTRUCTION)
    elif isinstance(injection, ScriptureInjection):
        sys_prompt = build_scripture_system_prompt(injection, BASE_INSTRUCTION)
    else:
